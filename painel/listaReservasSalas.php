        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">LISTA DE RESERVA DAS SALAS DE REUNIÃO</h6>
            </div>
            <div class="card-body">
...
while($linha = $query->fetch(PDO::FETCH_OBJ)){ ?>
    ...
    <div class="col-xl-12 bordasFont pl-0 px-0 pt-0 pb-0" style="border-top: 1px solid #ededed; padding: 10px 0; font-size: 12px">
      <div class="row"> 
        ...
        <div class="col-md-2 bordas pt-3 pb-3"><?php  echo $sala = ($linha->sala == "G" ? "Sala de Reunião Grande" : "Sala de Reunião Pequena") ;?></div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">EDITAR KM DO VEÍCULO</h5>
