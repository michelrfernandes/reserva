...
// $listar = "SELECT * FROM reservas WHERE situacao = 'Reservado' AND placa = '".$placaVet."'
// AND :data_start BETWEEN data_start AND data_end
// OR situacao = 'Reservado' AND  placa = '".$placaVet."' AND :data_end BETWEEN data_start AND data_end
// OR situacao = 'Reservado' AND placa = '".$placaVet."' AND (
//     situacao = 'Reservado' AND 
...
$incluir = "INSERT INTO reservas (id_users, veiculo, nome, placa, data_start, data_end, repeticao, duracao, km_entrada, km_saida, comentario, informacao, situacao, color) 
        VALUES (:idUser, :veiculo, :nome, :placa, :data_start, :data_end, :repeticao, :duracao, :rodagem, :km_saida, :comentario, :informacao, :situacao, :color)";
