...
<head>
  ...
  <script src="./calendario-salaJs.js"></script>
              ...
              <div class="card shadow h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <i class="fas fa-chalkboard-teacher fa-sm fa-fw mr-2 text-primary"></i>
                    RESERVA DA SALA DE REUNIÃO</span>
                    </div>    

                    <div class="col-xl-12">
                        <!-- AQUI O CALENDARIO -->
                        <div style="padding: 0px 50px" id='calendarSalas'></div>                   
                    <div>                           
